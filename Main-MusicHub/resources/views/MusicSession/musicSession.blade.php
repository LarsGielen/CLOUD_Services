<x-app-layout>
    ...
    <div id="joinView">
        <div class="bg-white shadow-sm sm:rounded-lg mx-12 p-6 my-4">
            ...
            <div class="flex gap-4">
                <x-text-input id="roomNameInput" class="w-full" type="text"></x-text-input>
    ...
    <div id="sessionView">
        <div class="bg-white shadow-sm sm:rounded-lg mx-12 p-6 my-4 flex flex-col gap-4">
            <div class="flex gap-4 items-center">
                ...
                <p id="roomName" class="flex-grow"></p>
                <x-primary-button id="openSaveMusicSheetModalBtn">Save</x-primary-button>
            </div>
            <div class="flex gap-4">
                <div class="w-full">
    ...
    @include('MusicSession.Partials.save-modal')
</x-app-layout>
