<x-app-layout>
    ...
    <div class="bg-white shadow-sm sm:rounded-lg p-6 mx-12 my-4">
        <div class="flex justify-end gap-4">
            <h1 class="text-3xl font-bold flex-grow">{{ $organizer->name }}</h1>

        </div>
        <br>
        <div class="flex gap-4">
            <div>
                <img class="object-cover size-56 rounded-md" src="{{ $organizer->imageURL }}">
            </div>
            <div class="flex flex-col">
                <div class="grow">
                    <h2 class="text-xl font-semibold">Organisation Information</h2>
                    <p>contact person: {{ $organizer->contactPerson }}</p>
                </div>
            </div>
        </div>
        <br>
    ...
    <div class="mx-12 my-6">
        <h1 class="text-3xl font-bold flex-grow">Events from this organisation</h1>
